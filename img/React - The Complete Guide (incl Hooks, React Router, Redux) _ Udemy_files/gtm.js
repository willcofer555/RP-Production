...
"resource": {
  ...
  "rules":[
    ...
    [["if",5,6],["add",4,11,12,16,18,19,23,26,28,44,55,56,63,64,1,67,2,70,71]],
    [["if",3,7],["add",5,6]],
    [["if",3,4],["add",7],["block",3,9,38,0,43,49,52,57,61]],
    [["if",3],["add",7,43,57,60,30,31,33,34,35]],
    ...
    [["if",3,17],["add",14]],
    [["if",3,18],["add",14]],
    [["if",3,19],["add",14,17],["block",49]],
    [["if",3,20],["add",14],["block",49]],
    [["if",3,21],["add",14]],
    [["if",3,22],["add",14]],
    ...
    [["if",3,38],["add",14]],
    [["if",14,39,40],["add",15,48]],
    [["if",3,41],["add",17]],
    [["if",3,42],["add",17]],
    [["if",43],["add",21]],
    [["if",3,44],["add",22,25,53]],
    [["if",3,45],["add",24,29,45,1,65,2,68]],
    [["if",3,46],["add",27]],
    [["if",3,47],["add",27]],
    [["if",3,48],["add",27]],
    [["if",3,49],["add",32]],
    [["if",52],["unless",50,51],["add",36]],
    [["if",53],["add",37]],
    [["if",3,54],["add",38],["block",49,57,62]],
    [["if",3,55],["unless",56],["add",38]],
    [["if",57,58],["add",38]],
    [["if",3,61],["add",0]],
    [["if",63,64],["add",39]],
    [["if",53,65],["add",40]],
    [["if",14,66],["add",41,58,1,66,2,69]],
    [["if",67,68],["add",42]],
    [["if",5,69],["add",46]],
    [["if",0,3],["unless",1,59],["add",49,61]],
    [["if",5,6,74],["add",50,51]],
    [["if",0,3,74],["add",52]],
